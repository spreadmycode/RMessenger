...
public class UiUtils {
    ...
    public static Drawable getOnlineMarkDrawable(boolean online) {
        return online ? ResourceUtils.getDrawable(R.drawable.ic_mark_online) : ResourceUtils.getDrawable(R.drawable.ic_mark_offline);
    }
}