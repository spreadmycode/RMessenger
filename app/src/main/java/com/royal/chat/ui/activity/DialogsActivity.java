...
import com.royal.chat.utils.qb.callback.QBPushSubscribeListenerImpl;
import com.royal.chat.utils.qb.callback.QbEntityCallbackImpl;
...
public class DialogsActivity extends BaseActivity implements DialogsManager.ManagingDialogsCallbacks, GetImageFileListener {
    ...
    private static final int REQUEST_SELECT_CONTACT = 156;
...
//        SmsHelper.getInstance(this).unregisterReceiver();
    ...
    private void startRepeatingTask() {
        DialogsActivity.this.runOnUiThread(mStatusChecker);
    }
