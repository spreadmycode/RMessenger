...
import com.royal.chat.utils.StorageUtils;
...
public class AttachmentPreviewAdapter extends BaseAdapter {
    ...
    public void add(final File item, String attachmentType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String mimeType = StorageUtils.getMimeType(attachmentFile);
        ...
        if (mimeType.contains("image")) {
            ...
            holder.attachmentImageView.setImageResource(R.drawable.audio_icon);
        }
